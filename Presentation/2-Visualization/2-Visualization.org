...
#+TITLE: Select Plots for Discussion about Data Visualization
...
* TD2 select graphics for discussion
Your plots
...
#+END_CENTER
* MugnierJu (Mexico Exports)
Interactive plot by the Huffington Post:
- [[http://atlas.media.mit.edu/en/visualize/embed/tree_map/hs92/export/mex/show/all/2014/][Treemap Visualization]]

\bigskip

[[http://www.huffingtonpost.fr/2017/01/26/avec-ce-graphique-on-voit-mal-comment-le-mexique-pourra-refuser/][Original report]]
* Nopest (NASA Budget)
#+BEGIN_CENTER
